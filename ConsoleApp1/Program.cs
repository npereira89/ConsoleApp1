...
namespace Calculadora
{
    public class Program
    {
        ...
        static void Main()
        {
            ...
            if (string.IsNullOrEmpty(value_calc) || [GeneratedRegex(value_calc, "[a-zA-Z]")] || value_calc.Length> 1)   
            {
        ...
        static void Soma(int a, int b)  /* efetua os calculos de soma */
        {
            ...
            if (Regex.IsMatch(volta_menu, "[a-zA-Z]") || [GeneratedRegex(volta_menu, "[1-99999999999999999]")] || string.IsNullOrEmpty(volta_menu))
            {
                Main();
